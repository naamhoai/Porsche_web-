                        ...
                        <tbody>
                            <c:forEach items="${list}" var="o">
                                <tr>
                                   ...
                                   <td><fmt:formatNumber value="${o.price}" type="number" groupingUsed="true"/></td>
                                    <td>${o.stock}</td>
                                    <td>${o.category}</td>
                                </tr> 
                            </c:forEach>
                    ...
                    <div style="text-align: center;" class="clearfix">
                        ...
                        <ul class="pagination" style="display: flex; align-items: center; justify-content: center;">
                            <c:if test="${requestScope.tag>1}">
                                <li class="page-item">
                                    <a href="show-products?index=${requestScope.tag-1}" class="page-link" aria-label="Go to previous page">Trước đó</a>
                                </li>
                            </c:if>
                            ...
                            <c:if test="${requestScope.tag < requestScope.endP}">
                                <li class="page-item">
                                    <a href="show-products?index=${requestScope.tag+1}" class="page-link" aria-label="Go to next page">Tiếp theo</a>
                                </li>
                            </c:if>
                        </ul>
                    </div>
